...
.jstree-default-dark .jstree-node,
.jstree-default-dark .jstree-icon {
  background-image: url("32px.eebaf260766f.png");
}
.jstree-default-dark .jstree-node {
...
.jstree-default-dark > .jstree-container-ul .jstree-loading > .jstree-ocl {
  background: url("throbber.62be6ed2b189.gif") center center no-repeat;
}
.jstree-default-dark .jstree-file {
  background: url("32px.eebaf260766f.png") -100px -68px no-repeat;
}
.jstree-default-dark .jstree-folder {
  background: url("32px.eebaf260766f.png") -260px -4px no-repeat;
}
...
.jstree-default-dark-small .jstree-file {
  background: url("32px.eebaf260766f.png") -103px -71px no-repeat;
}
.jstree-default-dark-small .jstree-folder {
  background: url("32px.eebaf260766f.png") -263px -7px no-repeat;
}
...
.jstree-default-dark-large .jstree-file {
  background: url("32px.eebaf260766f.png") -96px -64px no-repeat;
}
.jstree-default-dark-large .jstree-folder {
  background: url("32px.eebaf260766f.png") -256px 0px no-repeat;
}
...
@media (max-width: 768px) {
  ...
  #jstree-dnd.jstree-dnd-responsive > .jstree-ok {
    background-image: url("40px.51286e68b083.png");
...
@media (max-width: 768px) {
  ...
  .jstree-default-dark-responsive .jstree-file {
    background: url("40px.51286e68b083.png") 0 -160px no-repeat;
    background-size: 120px 240px;
  }
  .jstree-default-dark-responsive .jstree-folder {
    background: url("40px.51286e68b083.png") -40px -40px no-repeat;
    background-size: 120px 240px;
  }
  .jstree-default-dark-responsive > .jstree-container-ul > .jstree-node {
    margin-left: 0;
