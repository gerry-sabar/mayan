...
.jstree-default-dark > .jstree-container-ul .jstree-loading > .jstree-ocl {
  background: url("throbber.47023ceec8bd.gif") center center no-repeat;
}
...
@media (max-width: 768px) {
  ...
  #jstree-dnd.jstree-dnd-responsive > .jstree-ok {
    background-image: url("40px.bd7f4e4b9eb9.png");
...
@media (max-width: 768px) {
  ...
  .jstree-default-dark-responsive .jstree-file {
    background: url("40px.bd7f4e4b9eb9.png") 0 -160px no-repeat;
    background-size: 120px 240px;
  }
  .jstree-default-dark-responsive .jstree-folder {
    background: url("40px.bd7f4e4b9eb9.png") -40px -40px no-repeat;
    background-size: 120px 240px;
  }
  .jstree-default-dark-responsive > .jstree-container-ul > .jstree-node {
    margin-left: 0;
